...
class Infer():
    ...
    def __init__(self, verbose=1):
        ...
        self.system_dict["params"]["output"] = "/content/drive/My Drive/Datasets/Clinical_Reports/Testing/Regions/";
    ...
    def Predict(self, img_path, conf_thres=0.3, iou_thres=0.5):
        ...
        shutil.copyfile(img_path, source+"/"+os.path.basename(img_path)) 
