...
class Detector():
    ...
    def set_hyperparams(self, optimizer="sgd", lr=0.00579, multi_scale=False, evolve=False, num_generations=2, 
        ...
        self.system_dict["params"]["weights"] = '/content/drive/My Drive/Datasets/Clinical_Reports/yolov3-tiny.weights';
    ...
    def start_training(self):
        ...
        if(self.system_dict["dataset"]["val"]["status"]):
            ...
            if len(n):
                ...
                os.rename('/content/drive/My Drive/Datasets/Clinical_Reports/Results/results.txt', fresults)
